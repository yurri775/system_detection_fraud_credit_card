...
if __name__ == '__main__':
    ...
    cass_rw = CassandraReadWriteDb(ip_addrs=['172.25.198.7'], keyspace="emp")

    #Load data in cassandra from csv files
    cass_rw.sync_class_table(TxInfoModel)
    cass_rw.write_file_table('C:/Users/vente/OneDrive/Bureau/credit-card-fraud-detection-main/creditcard.csv')
